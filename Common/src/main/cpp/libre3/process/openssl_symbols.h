...
L3_CRYPTO_PROJECT_EXTERN int (*EVP_DigestInit_exptr)(EVP_MD_CTX *ctx, const EVP_MD *type, ENGINE *impl) L3_CRYPTO_PROJECT_INIT;
L3_CRYPTO_PROJECT_EXTERN int (*EVP_DigestFinal_exptr)(EVP_MD_CTX *ctx, unsigned char *md, unsigned int *s) L3_CRYPTO_PROJECT_INIT;
